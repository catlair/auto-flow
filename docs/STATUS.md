...
| **流程图模型** | [flow.md](modules/flow.md) | ✅ | 174 测试 + 71 前端用例 | **v4：节点 + 有向边**；出口名分派、汇合、循环上限、旧文件迁移；节点改动按 uid 寻址 |
...
| 前端界面 | [frontend.md](modules/frontend.md) | ✅ | 真机 + 71 前端用例 | v4 画布（@vue-flow/core）；响应驱动刷新；诊断面板显示后端告警 |
